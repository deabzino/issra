...
function render(type) {
  ...
  if (type === "about") content.innerHTML = base("from the diary / page 01", "a little page about u", "some things deserve to be said plainly, so here we are.", `<div class="diary-page"><span class="page-doodle one">✦</span><span class="page-doodle two">♡</span><p>you're genuinely one of the most patient people i've met. you've put up with a lot from me and somehow still managed to care even when things got difficult. you're honest about how you feel even when it's hard to say and i respect that a lot. you've always cared about doing what's right for yourself and getting closer to your deen too and that's something i genuinely respect about u.</p></div>`);
  if (type === "according") {
